...
#define CONFIG_SND_SOC_TAS2560_STEREO 1

#define CONFIG_TAS2560_REGMAP_STEREO 1
#define CONFIG_TAS2560_CODEC_STEREO 1
#define CONFIG_TAS2560_MISC_STEREO 1

#define CONFIG_SMART_AMP 1
